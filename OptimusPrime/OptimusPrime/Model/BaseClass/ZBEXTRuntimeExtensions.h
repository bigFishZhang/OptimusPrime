...
typedef enum {
     ...
     */
    zb_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    zb_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    zb_propertyMemoryManagementPolicyCopy
} zb_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     */
    zb_propertyMemoryManagementPolicy memoryManagementPolicy;
