...
// viewModel
@property (nonatomic, readwrite, strong) ZBViewModel *viewModel;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    ZBViewController *viewController = [super allocWithZone:zone];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    /// 隐藏导航栏细线
    self.viewModel.prefersNavigationBarBottomLineHidden?[(ZBNavigationController *)self.navigationController
                                                         hideNavigationBottomLine]:[(ZBNavigationController *)self.navigationController showNavigationBottomLine];
    /// 配置键盘
...
- (void)viewDidLoad {
    ...
    /// backgroundColor
    self.view.backgroundColor = ZB_MAIN_BACKGROUNDCOLOR;
